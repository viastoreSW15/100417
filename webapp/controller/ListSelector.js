sap.ui.define([
		...
		return BaseObject.extend("asug.model.ListSelector", {
			 ...
			 * @return {asug.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
