/*global history */
sap.ui.define([
		"asug/controller/BaseController",
		...
		"sap/ui/Device",
		"asug/model/formatter",
		"asug/model/grouper",
		"asug/model/GroupSortState"
		...
		return BaseController.extend("asug.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("asug.view.ViewSettingsDialog", this);
